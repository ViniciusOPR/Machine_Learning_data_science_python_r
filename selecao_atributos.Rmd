...
```
Dividimos os dados em treino e teste - Definimos semente para ser possível 
repetir experimento
```{r}
set.seed(234)
...
```
Criamos um primeiro modelo com todos os atributos - avaliamos a acurácia
```{r}
